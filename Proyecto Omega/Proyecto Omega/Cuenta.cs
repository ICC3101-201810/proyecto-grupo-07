...
namespace Proyecto_Omega
{
    public class Cuenta
    {
        ...
        {                                            // para crear un apunte
            Apunte miApunte = new Apunte(this, (string)miDatos[0], (string)miDatos[1], (List<string>)miDatos[2],
        ...
        {   // Al buscar por ID a lo mas puede haber un resultado
            ...
            if (miApunte.Count == 1)
            {
                ...
                {                                          // solo se puede actualizar uno a la vez.
                    miApunte[0].titulo = miDatos[0];       // Aqui solo se puede cambiar titulo, curso, 
                    return true;                           // topicos (uno a la vez), carrera y contenido
                }                                          // los otros datos tienen otros metodos.
                else if (miDatos[1] != "")
                {
                    miApunte[0].curso = miDatos[1];
                    return true;
                }
